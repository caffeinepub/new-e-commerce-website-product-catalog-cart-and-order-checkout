...
export class Backend implements backendInterface {
    ...
    async createProduct(arg0: string, arg1: bigint, arg2: string, arg3: string): Promise<ProductId> {
        if (this.processError) {
            try {
    ...
    async placeOrder(arg0: NewOrder): Promise<OrderId> {
        if (this.processError) {
            try {
    ...
    async setProductAvailability(arg0: ProductId, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
